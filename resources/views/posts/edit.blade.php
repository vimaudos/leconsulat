...
@section('content')
    ...
    <div class="container">
        <div class="col-sm-12">
            ...
            <h1>{{trans('backoffice.modifier')}} <small>{{ $posts->titre }}</small></h1>  
            <br/>
            {!! Form::model($posts, ['route' => ['post.update', $posts->id], 'method' => 'put', 'class' => 'form-horizontal validate', 'files' => true]) !!}
                <!-- Nav tabs -->
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="fr">
                        <div class="form-group {!! $errors->has('titre') ? 'has-error' : '' !!}">
                            ...
                            {!! Form::text('titre_fr', $posts->translate('fr')->titre, ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group {!! $errors->has('contenu') ? 'has-error' : '' !!}">
                            ...
                            {!! Form::textarea ('contenu_fr', $posts->translate('fr')->contenu, ['class' => 'form-control']) !!}
                    ...
                    <div role="tabpanel" class="tab-pane" id="en">
                        <div class="form-group {!! $errors->has('titre') ? 'has-error' : '' !!}">
                            ...
                            {!! Form::text('titre_en', $posts->translate('en')->titre, ['class' => 'form-control']) !!}
                            {!! $errors->first('titre_en', '<small class="help-block">:message</small>') !!}
                        </div>
                        <div class="form-group {!! $errors->has('contenu') ? 'has-error' : '' !!}">
                            <label for="contenu_en">{{trans('backoffice.contenu_en')}}</label>
                            {!! Form::textarea ('contenu_en', $posts->translate('en')->contenu, ['class' => 'form-control']) !!}
                    ...
                    <div role="tabpanel" class="tab-pane" id="es">
                        <div class="form-group {!! $errors->has('titre') ? 'has-error' : '' !!}">
                            ...
                            {!! Form::text('titre_es', $posts->translate('es')->titre, ['class' => 'form-control']) !!}
                            {!! $errors->first('titre_es', '<small class="help-block">:message</small>') !!}
                        </div>
                        <div class="form-group {!! $errors->has('contenu') ? 'has-error' : '' !!}">
                            <label for="contenu_es">{{trans('backoffice.contenu_es')}}</label>
                            {!! Form::textarea ('contenu_es', $posts->translate('es')->contenu, ['class' => 'form-control']) !!}
                    ...
                    <div role="tabpanel" class="tab-pane" id="pt">
                        <div class="form-group {!! $errors->has('titre') ? 'has-error' : '' !!}">
                            ...
                            {!! Form::text('titre_pt', $posts->translate('pt')->titre, ['class' => 'form-control']) !!}
                            {!! $errors->first('titre_pt', '<small class="help-block">:message</small>') !!}
                        </div>
                        <div class="form-group {!! $errors->has('contenu') ? 'has-error' : '' !!}">
                            <label for="contenu_pt">{{trans('backoffice.contenu_pt')}}</label>
                            {!! Form::textarea ('contenu_pt', $posts->translate('pt')->contenu, ['class' => 'form-control']) !!}
                    ...
                    <div role="tabpanel" class="tab-pane" id="de">
                        <div class="form-group {!! $errors->has('titre') ? 'has-error' : '' !!}">
                            ...
                            {!! Form::text('titre_de', $posts->translate('de')->titre, ['class' => 'form-control']) !!}
                            {!! $errors->first('titre_de', '<small class="help-block">:message</small>') !!}
                        </div>
                        <div class="form-group {!! $errors->has('contenu') ? 'has-error' : '' !!}">
                            <label for="contenu_de">{{trans('backoffice.contenu_de')}}</label>
                            {!! Form::textarea ('contenu_de', $posts->translate('de')->contenu, ['class' => 'form-control']) !!}
                    ...
                    <div role="tabpanel" class="tab-pane" id="it">
                        <div class="form-group {!! $errors->has('titre') ? 'has-error' : '' !!}">
                            ...
                            {!! Form::text('titre_it', $posts->translate('it')->titre, ['class' => 'form-control']) !!}
                            {!! $errors->first('titre_it', '<small class="help-block">:message</small>') !!}
                        </div>
                        <div class="form-group {!! $errors->has('contenu') ? 'has-error' : '' !!}">
                            <label for="contenu_it">{{trans('backoffice.contenu_it')}}</label>
                            {!! Form::textarea ('contenu_it', $posts->translate('it')->contenu, ['class' => 'form-control']) !!}
                ...
                {!! Form::submit(trans('backoffice.modifier'), ['class' => 'btn btn-info pull-right']) !!}
            {!! Form::close() !!}
