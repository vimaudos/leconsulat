...
function btnAction() {
    var action = document.getElementsByClassName('btn-act')[0];
    
    action.onclick = function(){
        
        var act = document.getElementsByClassName('action-content')[0],
            icon = action.getElementsByTagName('i')[0];
...
function animArticles(){
    var art = document.getElementsByClassName('link-article');

    setTimeout(function(){
        for(var i = 0; i < art.length; i++){
            art[i].style.opacity = "1";
        }
    }, 100);
}
